...
namespace dx
{
    ...
    MakeElementDesc(VSSemantics semantics, std::uint32_t inputSlot,
                    DxgiFormat format, std::uint32_t semanticsIndex = 0);
    D3D11_INPUT_ELEMENT_DESC
    MakeInstancingElementDesc(VSSemantics semantics, std::uint32_t inputSlot,
                              DxgiFormat format, std::uint32_t stepRate = 1,
                              std::uint32_t semanticsIndex = 0);
